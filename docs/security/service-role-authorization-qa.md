# QA service-role trust model and authorization inventory

This document is the Finding #2 inventory and acceptance contract for the QA
backend. It contains no credentials or customer data. The inventory was taken
from QA commit `99736188d0b3ef9a4eb20fa01f22e6edadbd0101` before implementation.
