...
-- never the source of truth. Browser roles intentionally receive no access.
...
values
  ...
  ('oral and maxillofacial surgery','oral and maxillofacial surgery','alias','oral and maxillofacial surgery','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"specialties","confidence":"unverified"}',null),
  ('pediatric dentistry','pediatric dentistry','alias','pediatric dentistry','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"specialties","confidence":"unverified"}',null),
  ('occlusion','occlusion','alias','occlusion','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"clinical_anatomy","confidence":"unverified"}',null),
  ('malocclusion','malocclusion','alias','malocclusion','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"clinical_anatomy","confidence":"unverified"}',null),
  ('periapical','periapical','alias','periapical','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"clinical_anatomy","confidence":"unverified"}',null),
  ('interproximal','interproximal','alias','interproximal','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"clinical_anatomy","confidence":"unverified"}',null),
  ('edentulous','edentulous','alias','edentulous','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"clinical_anatomy","confidence":"unverified"}',null),
  ('cephalometric','cephalometric','alias','cephalometric','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"imaging_technology","confidence":"unverified"}',null),
  ('CAD/CAM','cad/cam','alias','cad cam','industry','dental','industry_seed','suggested',true,1,true,true,'{"category":"imaging_technology","confidence":"unverified"}',null),
  ('intraoral scanner','intraoral scanner','alias','intraoral scanner','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"imaging_technology","confidence":"unverified"}',null),
  ('panoramic','panoramic','alias','panoramic','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"imaging_technology","confidence":"unverified"}',null),
  ('bitewing','bitewing','alias','bitewing','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"imaging_technology","confidence":"unverified"}',null),
  ('scaling and root planing','scaling and root planing','alias','scaling and root planing','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('pulpotomy','pulpotomy','alias','pulpotomy','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('pulpectomy','pulpectomy','alias','pulpectomy','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('endodontic therapy','endodontic therapy','alias','endodontic therapy','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('composite','composite','alias','composite','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('amalgam','amalgam','alias','amalgam','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('zirconia','zirconia','alias','zirconia','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('porcelain-fused-to-metal','porcelain-fused-to-metal','alias','porcelain fused to metal','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"procedures_materials","confidence":"unverified"}',null),
  ('Invisalign','invisalign','alias','invisalign','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"orthodontic_specialty","confidence":"unverified"}',null),
  ('aligners','aligners','alias','aligners','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"orthodontic_specialty","confidence":"unverified"}',null),
  ('cephalometric tracing','cephalometric tracing','alias','cephalometric tracing','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"orthodontic_specialty","confidence":"unverified"}',null),
  ('Open Dental','open dental','alias','Open Dental','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"dental_software_operations","confidence":"unverified","qa_role_mentions":0}',null),
  ('Dentrix','dentrix','alias','Dentrix','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"dental_software_operations","confidence":"unverified","qa_role_mentions":0}',null),
  ('Eaglesoft','eaglesoft','alias','Eaglesoft','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"dental_software_operations","confidence":"unverified","qa_role_mentions":0}',null),
  ('Curve','curve','alias','Curve','industry','dental','industry_seed','suggested',true,1,false,true,'{"category":"dental_software_operations","confidence":"unverified","qa_role_mentions":0}',null)
