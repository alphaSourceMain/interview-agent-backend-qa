...
const durable = fs.readFileSync(path.join(root, 'supabase/migrations/20260810144400_durable_otp_challenge_architecture.sql'), 'utf8');
const migration = fs.readFileSync(path.join(root, 'supabase/migrations/20260812141337_sms_c0_provider_delivery_recording_rpc.sql'), 'utf8');
